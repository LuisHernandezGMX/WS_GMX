...
#Region "Conversion RTFtoHTML"
    ...
    Public Function ConvertRtf2Html(rftString As String) As String
        ...
        If Not String.IsNullOrEmpty(_InterpreterLogFileName) Then
            interpreterLogger = New RtfInterpreterListenerFileLogger(_InterpreterLogFileName)
        End If
    ...
    Public Function ParseRtf_String(CadenaRTF As String) As IRtfGroup
        ...
        Using stream As Stream = GenerateStreamFromString(CadenaRTF)
            ...
            If Not String.IsNullOrEmpty(_ParserLogFileName) Then
                parser.AddParserListener(New RtfParserListenerFileLogger(_ParserLogFileName))
